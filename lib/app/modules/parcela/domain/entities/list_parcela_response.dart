...
ListParcelaResponse listProjetoResponseFromMap(String str) =>
    ListParcelaResponse.fromMap(json.decode(str));

String listProjetoResponseToMap(ListParcelaResponse data) =>
    json.encode(data.toMap());

class ListParcelaResponse {
  ...
  factory ListParcelaResponse.fromMap(Map<dynamic, dynamic> json) =>
      ListParcelaResponse(
        parcelas:
            List<Parcela>.from(json["content"].map((x) => Parcela.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        "content": List<dynamic>.from(parcelas.map((x) => x.toMap())),
