...
part 'create_arvore_story.g.dart';

class CreateArvoreStore = _CreateArvoreStoreBase with _$CreateArvoreStore;

abstract class _CreateArvoreStoreBase with Store {
  @observable
  ...
  bool isValidFields() {
    return validarNumeroArvore() && validarDap() && validarAltura();
  }
}
